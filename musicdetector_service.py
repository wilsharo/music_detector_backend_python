...
def process_chunk(chunk_file_path, result_file_path):
    """
    Initializes a fresh Segmenter and processes a single audio chunk.
    """
    try:
        # Initialize a fresh segmenter inside the new process
        from inaSpeechSegmenter import Segmenter
        from pydub import AudioSegment
        seg = Segmenter()
        ...
        with tempfile.NamedTemporaryFile(suffix=".wav", delete=True) as temp_wav:
            ...
            # Write the successful result to the result file as JSON
...
def segment_audio():
    print("--- Music Segmentation Request Received ---")
    ...
    try:
        ...
        ffprobe_command = [
            ...
            '-print_format', 'json', original_temp_audio_path
        ]
        ...
        print("Running FFmpeg to split audio into chunks...")
